      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 3:
            ...
            setMessage({
              type: "error",
              text: "Invite failed. Try again later.",
            });
            track("invite_submitted", {
              ui: "old",
              success: false,
      ...
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            children: [
              _jsx("h1", {
                style: { margin: 0, fontSize: 26, letterSpacing: "-0.3px" },
                children: "Users",
              }),
              _jsx("p", {
      ...
      message &&
        _jsxs("div", {
          ...
          children: [
            _jsx("strong", {
              style: { marginRight: 6 },
              children: message.type === "success" ? "OK:" : "Error:",
            }),
            message.text,
          ],
        }),
                ...
                filtered.length === 0
                  ? _jsx("tr", {
                      children: _jsx("td", {
                        ...
                        children: "Nothing here. Try a different search.",
                      }),
                    })
        ...
        _jsx("div", {
          ...
          children: _jsxs("div", {
            ...
            children: [
              ...
              _jsx("div", {
                style: { marginTop: 10, fontSize: 11, color: "#999" },
                children:
                  "In the New UI, modal + validation + feedback are consistent across pages.",
              }),
            ],
          }),
        }),
