...
import { SurveyPrompt } from "../../ui/SurveyPrompt.tsx";
...
export default function NewUsers() {
        ...
        switch (_b.label) {
          ...
          case 2:
            ...
            setUsers(function (prev) {
              return __spreadArray([newUser_1], prev, true);
            });
            setInviteName("");
            setInviteEmail("");
  ...
  var closeInvite = useCallback(function () {
    ...
    children: [
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            children: [
              _jsx("h1", { style: { margin: 0 }, children: "Users" }),
              _jsx("p", {
                style: { marginTop: 8, color: "#555" },
                children: "Manage access to your workspace.",
              }),
            ],
          }),
          _jsx(Button, { onClick: openInvite, children: "Invite user" }),
        ],
      }),
      _jsxs("div", {
        style: {
        ...
        children: [
          ...
          _jsxs("div", {
            ...
            children: [
              _jsx("label", { style: { fontWeight: 600 }, children: "Role" }),
              _jsxs("select", {
                value: roleFilter,
                onChange: function (e) {
                  var v = e.target.value;
                  setRoleFilter(v);
                  track("role_filter_changed", {
                    ui: ui,
                    page: "users",
                    role: v,
                  });
                ...
                children: [
                  _jsx("option", { value: "All", children: "All roles" }),
          ...
          _jsxs("div", {
            style: { color: "#666", paddingBottom: 6 },
            children: [
              "Showing ",
              _jsx("strong", { children: filtered.length }),
              " of",
              " ",
              _jsx("strong", { children: users.length }),
            ],
          }),
        ],
      }),
          ...
          children: [
            _jsx("thead", {
              children: _jsx("tr", {
                ...
                children: ["Name", "Email", "Role", "Status"].map(function (h) {
                  return _jsx(
                    "th",
                    {
                      style: {
        ...
        children: _jsxs("form", {
          ...
          children: [
            _jsx(Input, {
              ...
              value: inviteName,
              onChange: function (e) {
                return setInviteName(e.target.value);
              },
            ...
            _jsxs("div", {
              ...
              children: [
                ...
                _jsxs("select", {
                  value: inviteRole,
                  onChange: function (e) {
                    return setInviteRole(e.target.value);
                  },
                  style: {
                    padding: "10px 12px",
                    borderRadius: 10,
