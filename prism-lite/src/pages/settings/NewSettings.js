...
export default function NewSettings() {
  ...
  var _e = useState(false),
    touched = _e[0],
    setTouched = _e[1];
  var workspaceNameError = useMemo(
    function () {
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("h1", { style: { marginTop: 0 }, children: "Settings" }),
      _jsxs("form", {
        onSubmit: onSave,
          ...
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("div", {
                ...
                children: "New users start with this role.",
              }),
            ],
          }),
          _jsxs("label", {
            ...
            children: [
              ...
              _jsx("span", { children: "Allow team members to invite users" }),
            ],
          }),
          _jsxs("div", {
